...
class PairDriverTest {
    ...
    @Test
    public void testPairDriverLargestStadiumLargestAtEnd() throws StadiumException {
    ...
    @Test
    public void testPairDriverLargestStadiumLargestAtStart() throws StadiumException {
       // fail("Раскомментируйте тест после реализации класса PairDriver");
        Pair<String, Integer>[] stadiums = new Pair[3];
    ...
    @Test
    public void testPairDriverLargestStadiumLargestInMiddle() throws StadiumException {
        //fail("Раскомментируйте тест после реализации класса PairDriver");
        Pair<String, Integer>[] stadiums = new Pair[3];
        stadiums[0] = new Pair<String, Integer>("A", 3);
